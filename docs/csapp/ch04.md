...
![image-20221225181034068](http://cdn.docjerry.top/csapp/image-20221225181034068.png)
...
![image-20221225181110697](http://cdn.docjerry.top/csapp/image-20221225181110697.png)

- 其中对于`OPq`、`jXX`、`cmovXX`的指令，用**fn**区分功能：

![image-20221225181148486](http://cdn.docjerry.top/csapp/image-20221225181148486.png)

- 涉及到对寄存器的操作，将15个寄存器进行编码，F表示无寄存器

![image-20221225181219612](http://cdn.docjerry.top/csapp/image-20221225181219612.png)
...
![image-20221225181351906](http://cdn.docjerry.top/csapp/image-20221225181351906.png)
...
![image-20221225181506807](http://cdn.docjerry.top/csapp/image-20221225181506807.png)

![image-20221225181554191](http://cdn.docjerry.top/csapp/image-20221225181554191.png)

![image-20221225181728870](http://cdn.docjerry.top/csapp/image-20221225181728870.png)

- 入栈和出栈操作

![image-20221225181624690](http://cdn.docjerry.top/csapp/image-20221225181624690.png)

- 控制转移指令

![image-20221225181706975](http://cdn.docjerry.top/csapp/image-20221225181706975.png)
...
![image-20221225181823477](http://cdn.docjerry.top/csapp/image-20221225181823477.png)
...
![image-20221225181900479](http://cdn.docjerry.top/csapp/image-20221225181900479.png)
...
>
> ![image-20221225182000013](http://cdn.docjerry.top/csapp/image-20221225182000013.png)
...
![image-20221225182051651](http://cdn.docjerry.top/csapp/image-20221225182051651.png)

【例】顺序执行案例，5条指令通过流水线。在时刻5，流水线中并行运行5个指令的阶段

![image-20221225182135470](http://cdn.docjerry.top/csapp/image-20221225182135470.png)
...
![image-20221225182251508](http://cdn.docjerry.top/csapp/image-20221225182251508.png)

- **数据转发**：`irmovq`的Execute后，输出值`valE`直接作为`addq`的输入，而不Write back到寄存器然后再取出。此时`addq`的Decode可以和`irmovq`的Execute处于同一个时钟周期

![image-20221225182444826](http://cdn.docjerry.top/csapp/image-20221225182444826.png)

- **结合使用**：`mrmovq`的Memory结束后，`addq`指令才能读取到`valA`的值。单纯使用数据转发无法解决这种情况，需要结合暂停技术。增加1个 **`bubble`**

![image-20221225182534665](http://cdn.docjerry.top/csapp/image-20221225182534665.png)
...
![image-20221225182606979](http://cdn.docjerry.top/csapp/image-20221225182606979.png)
...
![image-20221225182800743](http://cdn.docjerry.top/csapp/image-20221225182800743.png)
...
![image-20221225182857929](http://cdn.docjerry.top/csapp/image-20221225182857929.png)

- 对于数据冒险和控制冒险，流水线寄存器需要**加入暂停或气泡**处理：

![image-20221225183133444](http://cdn.docjerry.top/csapp/image-20221225183133444.png)
...
![image-20221225183000502](http://cdn.docjerry.top/csapp/image-20221225183000502.png)
...
```
![image-20221225183539598](http://cdn.docjerry.top/csapp/image-20221225183539598.png)
