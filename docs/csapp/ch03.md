...
![image-20221225133404612](http://cdn.docjerry.top/csapp/image-20221225133404612.png)
...
![image-20221225133529550](http://cdn.docjerry.top/csapp/image-20221225133529550.png)
...
![image-20221225133614041](http://cdn.docjerry.top/csapp/image-20221225133614041.png)



【例】书中例子：假设寄存器和内存地址的值如下

![image-20221225133649677](http://cdn.docjerry.top/csapp/image-20221225133649677.png)

那么所示操作数的值如下：

![image-20221225133805372](http://cdn.docjerry.top/csapp/image-20221225133805372.png)
...
![image-20221225133938256](http://cdn.docjerry.top/csapp/image-20221225133938256.png)
...
![image-20221225134044111](http://cdn.docjerry.top/csapp/image-20221225134044111.png)
...
![image-20221225134129923](http://cdn.docjerry.top/csapp/image-20221225134129923.png)
...
![image-20221225134222748](http://cdn.docjerry.top/csapp/image-20221225134222748.png)
...
![image-20221225204233038](http://cdn.docjerry.top/csapp/image-20221225204233038.png)
...
![image-20221225134313323](http://cdn.docjerry.top/csapp/image-20221225134313323.png)
...
![image-20221225134402144](http://cdn.docjerry.top/csapp/image-20221225134402144.png)
...
![image-20221225134458169](http://cdn.docjerry.top/csapp/image-20221225134458169.png)
...
![image-20221225134624981](http://cdn.docjerry.top/csapp/image-20221225134624981.png)

【编译】对应的汇编语句

![image-20221225134658270](http://cdn.docjerry.top/csapp/image-20221225134658270.png)

其中，跳转表用以下声明表示

![image-20221225134730020](http://cdn.docjerry.top/csapp/image-20221225134730020.png)
...
![image-20221225134831417](http://cdn.docjerry.top/csapp/image-20221225134831417.png)



### 3.7.2 转移控制——CALL和RET

![image-20221225134910567](http://cdn.docjerry.top/csapp/image-20221225134910567.png)
...
![image-20221225171131833](http://cdn.docjerry.top/csapp/image-20221225171131833.png)

- **函数参数>6**：1~6使用**寄存器**传递，多于6的部分通过**栈**来传递。
- **函数返回**：通过`%rax`返回

![image-20221225171228885](http://cdn.docjerry.top/csapp/image-20221225171228885.png)

【说明】使用栈传参时，所有数据的大小按8字节对齐，这里`a4`虽然是`char`类型，在栈存储时占8字节空间

![image-20221225171303251](http://cdn.docjerry.top/csapp/image-20221225171303251.png)
...
![image-20221225171417838](http://cdn.docjerry.top/csapp/image-20221225171417838.png)
...
![image-20221225171453994](http://cdn.docjerry.top/csapp/image-20221225171453994.png)
...
![image-20221225171539837](http://cdn.docjerry.top/csapp/image-20221225171539837.png)
...
![image-20221225171953786](http://cdn.docjerry.top/csapp/image-20221225171953786.png)
...
![image-20221225172053067](http://cdn.docjerry.top/csapp/image-20221225172053067.png)
...
![image-20221225172206370](http://cdn.docjerry.top/csapp/image-20221225172206370.png)
...
![image-20221225172236669](http://cdn.docjerry.top/csapp/image-20221225172236669.png)
...
![image-20221225172324195](http://cdn.docjerry.top/csapp/image-20221225172324195.png)
...
![image-20221225172347705](http://cdn.docjerry.top/csapp/image-20221225172347705.png)
...
![image-20221225180019080](http://cdn.docjerry.top/csapp/image-20221225180019080.png)
...
![image-20221225172545161](http://cdn.docjerry.top/csapp/image-20221225172545161.png)
...
![image-20221225172626417](http://cdn.docjerry.top/csapp/image-20221225172626417.png)
...
![image-20221225172719511](http://cdn.docjerry.top/csapp/image-20221225172719511.png)

### 3.11.1 浮点传送和转换操作

- `vmov`：把数据从一个XMM寄存器复制到另一个XMM寄存器，或者从内存复制。类似于整数的`mov`

![image-20221225172818795](http://cdn.docjerry.top/csapp/image-20221225172818795.png)
...
![image-20221225172859219](http://cdn.docjerry.top/csapp/image-20221225172859219.png)
...
![image-20221225173711224](http://cdn.docjerry.top/csapp/image-20221225173711224.png)
...
![image-20221225173757025](http://cdn.docjerry.top/csapp/image-20221225173757025.png)

### 3.11.6 浮点比较
- 单精度比较(`ucomiss`)、双精度比较(`ucomisd`)，与正数的`cmpq`效果一样

![image-20221225173827904](http://cdn.docjerry.top/csapp/image-20221225173827904.png)

- 浮点数比较后，会设置三个条件码：`ZF`(零标志位)、`CF`(进位标志位)、`PF`(奇偶标志位)
  - 注：这里比整数运算多一个PF位，目的是区分任一操作数为$NaN$的情况

![image-20221225173912252](http://cdn.docjerry.top/csapp/image-20221225173912252.png)
